...
<section class="section founder about-him-block">
    <picture width="480" height="480">
      <source type="image/webp" srcset="img/about-logo-pic.webp">
      <source type="image/jpeg" srcset="img/about-logo-pic.jpg">
      <img src="img/about-logo-pic.jpg" alt="about-logo-pic" class="about-logo-pic">
    </picture>
...
<div class="container">
      <div class="swiper features-slider">
        <!-- обертка слайдера -->
        <ul class="swiper-wrapper header-features-black">
          <!-- слайды -->
...
<section class="section founder about-him-block">
    ...
    <!-- /.container -->
    <picture>
      <source type="image/webp" srcset="img/med-girl.webp">
      <source type="image/jpeg" srcset="img/med-girl.jpg">
      <img src="img/med-girl.jpg" alt="med-girl" class="med-girl">
    </picture>
</section>
