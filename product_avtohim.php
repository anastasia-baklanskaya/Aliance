...
<section class="section founder about-him-block">
    <picture>
      <source type="image/webp" srcset="img/laboratory.webp">
      <source type="image/jpeg" srcset="img/laboratory.jpg">
      <img src="img/laboratory.jpg" alt="laboratory" class="laboratory">
    </picture>
    <div class="container">
      <div class="founder-content-wrapper">
        <div class="founder-content about-him-title">
          <div class="seporator"></div>
          <h2 class="section-title">Контрактное производство автомобильной химии</h2>
          <p class="founder-text">
            Прежде всего, начало повседневной работы по формированию позиции однозначно фиксирует необходимость приоритизации разума над эмоциями. Кстати, представители современных социальных резервов неоднозначны и будут описаны максимально подробно. <br><br>
...
<div class="container">
      <div class="swiper features-slider">
        <!-- обертка слайдера -->
        <ul class="swiper-wrapper header-features-black product-features">
          <!-- слайды -->
          <li class="swiper-slide header-features-item-black">
...
<section class="section founder product-him-block">
    <div class="container">
      <div class="founder-content-wrapper">
        <div class="founder-content product-him-title">
          <div class="seporator"></div>
...
<section class="section blog">
    <div class="container">
      <div class="seporator"></div>
      <h2 class="section-title about-title">Исследовательский центр <br> Aliance production</h2>
      <!-- Slider main container -->
      <div class="about-aliance-text">
      <p class="founder-text about-text">
      ...
      <div class="swiper blog-slider">
        ...
        <div class="swiper-wrapper">
          <!-- Slides -->
          <a href="#" class="swiper-slide about-blog-card">
            <picture>
              <source type="image/webp" srcset="img/blog/blog-photo.webp">
              <source type="image/jpeg" srcset="img/blog/blog-photo.png">
              <img src="img/blog/blog-photo.png" alt="blog-photo" class="blog-card-image">
            </picture>
          </a>
          <a href="#" class="swiper-slide about-blog-card">
            <picture>
              <source type="image/webp" srcset="img/blog/blog-photo-2.webp">
              <source type="image/jpeg" srcset="img/blog/blog-photo-2.png">
              <img src="img/blog/blog-photo-2.png" alt="blog-photo-2" class="blog-card-image">
            </picture>
          </a>
          <a href="#" class="swiper-slide about-blog-card">
            <picture>
        ...
        <div class="blog-slider-footer about-blog-slider-footer">
...
<!-- /.section blog -->
<?php 
include_once('./template-parts/stages-block.php');
